...
function AdminDashboard({state,setState,currentUser,onOpenProject,onNavigate,showHeader=true}) {
  ...
  dashboardCards["project-health"]={size:"large",node:<div className="management-dashboard-card management-project-health" style={{height:"100%",background:"#fff",border:"1px solid #E2E8F0",borderRadius:16,padding:16,boxShadow:"0 5px 16px rgba(15,23,42,.04)"}}>
    ...
    <div className="admin-ai-summary">
      <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}>
        <div style={{display:"flex",gap:12,alignItems:"flex-start",minWidth:0,flex:1}}>
          <div className="admin-ai-icon" style={{width:38,height:38,borderRadius:13,display:"grid",placeItems:"center",background:"linear-gradient(135deg,#4A6CF7,#7C3AED)",color:"#fff",boxShadow:"0 10px 22px rgba(74,108,247,.22)",flexShrink:0}}><Icon name="activity" size={18}/></div>
