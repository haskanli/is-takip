...
function TrainingPanel({project,onChange,canEdit,people}) {
  ...
  return <div className="project-panel-page training-panel">
    <div className="project-panel-header"><div><h3>Eğitimler</h3><p>Proje kapsamındaki eğitimleri, katılımcıları ve devir notlarını takip edin.</p></div><input style={iStyle} value={search} onChange={event=>setSearch(event.target.value)} placeholder="Eğitimlerde ara..."/></div>
