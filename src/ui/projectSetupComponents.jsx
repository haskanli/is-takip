...
function ProjectOverviewPanel({project,onChange,canEdit}) {
  ...
  const statCards=[["Tamamlama",`%${progress}`,"#4F46E5",`${doneTasks}/${totalTasks} görev`],["Proje Sağlığı",`%${readinessScore(project)}`,readinessScore(project)>=Number(project.readinessThreshold||80)?"#059669":"#E11D48","hazırlık skoru"],["Geciken",lateTasks,"#EA6C00","açık termin"],["Risk",openRisks,"#E11D48","açık risk"]];
